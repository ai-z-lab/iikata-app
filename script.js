...
const patterns = [
  {
    category: "催促・急かし系",
    keywords: ["遅くない", "時間かかりすぎ", "時間がかかりすぎ", "時間かかり過ぎ", "時間がかかり過ぎ", "いつまでかかる", "いつまで掛かる", "まだ終わらない", "まだ終わらん"],
    categoryReason: "期限や所要時間への不安から、相手を急かしているように受け取られやすい表現です。",
    soft: "完了までにどのくらいかかりそうか、状況を確認させてもらってもいいですか？",
    softReason: "遅さを責めるのではなく、見通しを確認する形にしています。",
    business: "完了予定時刻と、対応に時間がかかっている要因があれば共有してください。",
    businessReason: "急かす印象を抑え、業務上必要な予定と状況の確認に置き換えています。",
    young: "あとどれくらいで終わりそうですか？困っているところがあれば一緒に確認しましょう。",
    youngReason: "相手を焦らせすぎず、相談できる余地を残す言い方にしています。"
  },
  {
    category: "進捗確認系",
...
function createDefaultResult() {
  return {
    category: "分類しきれない表現",
    categoryReason: "強い言い方の可能性はありますが、用意しているカテゴリのどれかに明確には寄せきれませんでした。",
