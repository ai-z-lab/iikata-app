...
const patterns = [
  {
    category: "催促・急かし系",
    keywords: ["遅くない", "時間かかりすぎ", "時間かかってる", "まだ終わらない", "まだ終わらん", "まだ終わってない", "まだ終わってへん", "まだ終わっとらん", "いつまでかかる", "いつ終わる", "まだ時間かかる", "もうできた", "早くして", "早くやって", "急いで", "急ぎ", "遅いよ", "遅すぎ", "まだ"],
    categoryReason: "相手を急かしたり、完了見込みを早く知りたい意図が強い表現です。",
    soft: "進み具合を確認させてもらってもいいですか？",
    softReason: "急かす印象を抑え、まず状況を確認する言い方にしています。",
    business: "現在の進捗状況と、完了見込みを共有してください。",
    businessReason: "感情的な催促ではなく、業務上必要な進捗と見込みの共有に置き換えています。",
    young: "今どのあたりで時間がかかっているか、一緒に確認しましょう。",
    youngReason: "遅さを責めず、つまずいている箇所を一緒に整理する表現にしています。"
  },
  {
    category: "進捗確認系",
...
function createDefaultResult() {
  return {
    category: "分類しきれない表現",
    categoryReason: "強い言い方の可能性はありますが、6カテゴリのどれかに明確には寄せきれませんでした。",
